...
const firebaseConfig = {
  // TODO: Replace with your Firebase web app config from Project Settings.
  ...
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "TODO_MESSAGING_SENDER_ID",
  appId: import.meta.env.VITE_FIREBASE_APP_ID || "TODO_APP_ID",
};

export const firebaseReady = !firebaseConfig.apiKey.startsWith("TODO");
